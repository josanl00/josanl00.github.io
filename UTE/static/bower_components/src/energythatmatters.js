...
(function() {
    ...
    Empowering.Graphics.OT101 = function(attrs) {
        ...
        */
        ...
        var width =  600,// other type of make it responsive but without autoresizing: var width = parseInt(d3.select('#per').style('width'), 10),
        height = width/2,
        barWidth = width / cons.length,
        labelSize = 24,
        barHeight = height - labelSize - 10,
        rectWidth = barWidth * 0.375,
        barEnerWidth = barWidth * 0.5;

        ot101.plot = d3.select(attrs.container)
                   .append('div')
                   .classed("svg-container-ot101", true) //container class to make it responsive
                   .append("svg")
